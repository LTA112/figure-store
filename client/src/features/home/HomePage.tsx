    ...
    return (
        <div
            className={[
              ...
              'bg-[#f4f1e9] text-6xl text-gray-300',
            ].join(' ')}
        >
          🧸
        </div>
...
export default function HomePage() {
  ...
  return (
      <>
          ...
          <div className="mx-auto grid min-h-[430px] max-w-7xl items-center gap-8 px-6 py-10 md:grid-cols-[1.08fr_0.92fr] lg:px-12">
            ...
            <div className="order-1 text-center md:order-2 md:text-left">
              ...
              <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-gray-700 md:mx-0 md:text-base">
                Vitoy mang những hình ảnh
                gần gũi trong văn hóa Việt
                Nam vào các mô hình sưu tầm
                có cá tính, đáng yêu và giàu
                câu chuyện.
              </p>
        ...
        >
          <div className="mx-auto max-w-6xl">
            <div className="mb-8 flex flex-col gap-5">
              ...
              <div className="flex gap-3 overflow-x-auto border-b border-slate-300 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                {collections.map(
                    (category) => {
                      const active =
                          category.id ===
                      ...
                      return (
                          <button
                              ...
                              className={[
                                'shrink-0 border-b-2 px-1 pb-4 text-sm font-bold transition',
                                active
                        ...
                        return (
                            ...
                            >
                              <article className="flex h-full flex-col overflow-hidden rounded-[28px] bg-white shadow-[0_14px_38px_rgba(15,23,42,0.10)] transition duration-300 hover:-translate-y-2 hover:shadow-[0_22px_50px_rgba(15,23,42,0.16)]">
                                {/* PRODUCT IMAGE */}
                                <div className="relative aspect-[4/5] overflow-hidden rounded-t-[28px] bg-[#f8f7f3]">
                                  <ProductImage
                                      product={product}
                                      className="h-full w-full scale-[1.2] object-cover object-center transition duration-500 group-hover:scale-[1.28]"
                                  />

                                  <div className="absolute left-4 top-4 z-10 flex flex-wrap gap-2">
                                    {product.newProduct && (
                                        <span className="rounded-full bg-[#3157d5] px-3 py-1 text-[10px] font-black uppercase tracking-wide text-white shadow-sm">
                                Mới
                              </span>
                                    )}

                                    {product.featured && (
                                        <span className="rounded-full bg-amber-300 px-3 py-1 text-[10px] font-black uppercase tracking-wide text-slate-900 shadow-sm">
                                Nổi bật
                              </span>
                                    )}
                                  </div>
                                  ...
                                  {outOfStock && (
                                      <div className="absolute inset-0 z-20 flex items-center justify-center bg-slate-950/35 backdrop-blur-[1px]">
                              <span className="rounded-full bg-white px-4 py-2 text-xs font-black uppercase text-slate-900 shadow-md">
                                Hết hàng
                              </span>
                                      </div>
                                  )}
          ...
          <div className="mx-auto grid min-h-[310px] max-w-6xl overflow-hidden rounded-[30px] bg-[#f7a007] md:grid-cols-2">
            <div className="flex flex-col justify-center px-10 py-10 text-white md:px-14">
              ...
              <p className="mt-4 max-w-md text-sm leading-7 text-white/90">
                Mỗi hộp là một nhân vật
                ngẫu nhiên thuộc các bộ sưu
                tập của Vitoy.
              </p>
            ...
            <div className="flex items-end justify-center overflow-hidden px-6 pt-5">
              <ProductImage
                  product={blindBoxProduct}
                  className="h-[290px] w-full max-w-[320px] object-contain drop-shadow-xl"
                  loading="eager"
              />
            </div>
          </div>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-[1fr_0.9fr]">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-gray-700">
                Vitoy là thương hiệu art
                toy lấy cảm hứng từ văn hóa
                và đời sống Việt Nam. Mỗi bộ
                sưu tập là một thế giới nhỏ,
                nơi những hình ảnh quen thuộc
                được kể lại bằng ngôn ngữ hiện
                đại, gần gũi và đáng yêu.
              </p>
        ...
        <section
            id="creators"
            className="scroll-mt-32 bg-white px-6 pb-16 pt-16 lg:px-14"
        >
          <div className="mx-auto max-w-6xl">
