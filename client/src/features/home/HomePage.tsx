...
export default function HomePage() {
  ...
  return (
      <>
        <section
            className="overflow-hidden bg-gradient-to-r from-[#f8f0d8] via-[#e9eedf] to-[#cdd9c9]"
            onMouseEnter={() => setHeroPaused(true)}
            onMouseLeave={() => setHeroPaused(false)}
        >
          <div className="mx-auto grid min-h-[440px] max-w-7xl items-center gap-10 px-6 py-12 md:grid-cols-[1.08fr_0.92fr] lg:px-12">
            <div className="order-2 flex justify-center md:order-1">
              <div className="relative h-[330px] w-full max-w-[560px] md:h-[390px]">
                <div className="absolute inset-x-20 bottom-4 h-14 rounded-[50%] bg-slate-900/10 blur-2xl" />
                ...
                {heroSlides.map((slide, index) => (
                    <img
                        ...
                        alt={slide.alt}
                        className={[
                          'absolute inset-0 h-full w-full object-contain object-center drop-shadow-xl transition-all duration-700',
                          index === safeActiveHeroSlide
            ...
            <div className="order-1 text-center md:order-2 md:text-left">
              <p className="text-xs font-bold uppercase tracking-[0.28em] text-[#3157d5]">
                Vietnamese art toys
              </p>

              <h1 className="mt-4 text-5xl font-black tracking-[-0.04em] text-slate-950 md:text-6xl lg:text-7xl">
                Vitoy
              </h1>

              <p className="mt-3 text-base font-black uppercase tracking-[0.18em] text-slate-500 md:text-lg">
                Văn hóa Việt trong từng mô hình
              </p>

              <p className="mx-auto mt-6 max-w-xl text-sm leading-7 text-slate-700 md:mx-0 md:text-base">
                Vitoy biến những hình ảnh gần gũi trong đời sống
                Việt Nam thành các mô hình sưu tầm có cá tính,
                đáng yêu và giàu câu chuyện.
              </p>

              <div className="mt-8 flex flex-wrap justify-center gap-3 md:justify-start">
                <Link
                    to="/products"
                    className="inline-flex items-center justify-center rounded-xl bg-slate-950 px-6 py-3.5 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-[#3157d5]"
                >
                  Xem mô hình
                </Link>
                ...
                <a
                    href="#collections"
                    className="inline-flex items-center justify-center rounded-xl border border-slate-400 bg-white/65 px-6 py-3.5 text-sm font-black text-slate-800 transition hover:-translate-y-0.5 hover:border-[#3157d5] hover:bg-white hover:text-[#3157d5]"
                >
                  Khám phá bộ sưu tập
                </a>
              </div>
                    ...
                    {heroSlides.map((slide, index) => (
                        <button
                            ...
                            className={[
                              ...
                              index === safeActiveHeroSlide
                                  ? 'w-8 bg-[#3157d5]'
                                  : 'w-2 bg-slate-400/45 hover:bg-slate-600',
                            ].join(' ')}
                        />
                    ))}
                  </div>
            ...
            <div className="mb-8 flex flex-col gap-5">
              ...
              <div className="flex gap-3 overflow-x-auto border-b border-slate-300 pb-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                {collections.map((category) => {
                  const active =
                      category.id === activeCollectionId
                  ...
                  return (
                      <button
                          ...
                          type="button"
                          onClick={() =>
                              setActiveCollectionId(category.id)
                          }
                        ...
                        >
                          <article className="flex h-full flex-col overflow-hidden rounded-[28px] bg-white shadow-[0_14px_38px_rgba(15,23,42,0.10)] transition duration-300 hover:-translate-y-2 hover:shadow-[0_22px_50px_rgba(15,23,42,0.16)]">
                            <div className="relative h-[300px] overflow-hidden bg-gradient-to-b from-[#fbf9f3] to-[#eee9df] sm:h-[320px]">
                              ...
                              {outOfStock && (
                                  <div className="absolute inset-0 z-20 flex items-center justify-center bg-slate-950/35">
          ...
          <div className="mx-auto grid min-h-[310px] max-w-6xl overflow-hidden rounded-[30px] bg-[#f7a007] md:grid-cols-2">
            <div className="flex flex-col justify-center px-10 py-10 text-white md:px-14">
              ...
              <p className="mt-4 max-w-md text-sm leading-7 text-white/90">
                Mỗi hộp là một nhân vật ngẫu nhiên thuộc các bộ
                sưu tập của Vitoy.
              </p>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-[1fr_0.9fr]">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-gray-700">
                Vitoy là thương hiệu art toy lấy cảm hứng từ
                văn hóa và đời sống Việt Nam. Mỗi bộ sưu tập
                là một thế giới nhỏ, nơi những hình ảnh quen
                thuộc được kể lại bằng ngôn ngữ hiện đại, gần
                gũi và đáng yêu.
              </p>
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-3 md:grid-cols-1 lg:grid-cols-3">
                {[
                  [
                    '01',
                    'Văn hóa Việt',
                    'Chất liệu quen thuộc được kể lại theo cách mới.',
                  ],
                  [
                    '02',
                    'Nhân vật riêng',
                    'Mỗi mô hình có màu sắc và cá tính riêng.',
                  ],
                  [
                    '03',
                    'Sưu tầm lâu dài',
                    'Thiết kế để trưng bày, lưu giữ và kết nối cảm xúc.',
                  ],
